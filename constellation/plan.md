...
connected_repos:
  ...
  - name: puzzle-lang
    path: packages/puzzle-lang
    description: The Puzzle template language plan (the shared parser Go module, D172)
---
...
- `repo=puzzle-lang` → `packages/puzzle-lang` — the template language Go module: the parser's FILE cards and its test card (the parser's contract and decisions stay in `puzzle`)
