---
name: DECISIONS.md — decision-log index (D1–D80)
status: verified
...
Index of the ADR-lite decision log. Each decision D1–D80 now lives as its own DECISION card (full context, rationale, rejected alternatives); this card is the numeric index. [[DOC-SPEC]] is the enforceable contract — every SPEC change requires a new decision card, numbered here.
