...
const app = new PuzzleApp({
  // Where the app mounts. In static mode (D79) `target` must be an `'#id'`
  ...
  // App lifecycle hook (v1.28, D60). In static mode (D79) this runs ONLY at build
...
// run in the browser. In static mode (D79) the build runs app.js under Node once
...
// Required by the static/hybrid build (D67/D79): the Go build imports this default
